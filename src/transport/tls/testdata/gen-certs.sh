...
ee() {
  ...
  hostname=${ee_deployment}.deployment.${ee_namespace}.linkerd-managed.${controller_namespace}.svc.cluster.local
  ...
  echo "  name: ${ee_deployment}-deployment-tls-linkerd-io" >> ${secret}
  echo "data:" >> ${secret}
