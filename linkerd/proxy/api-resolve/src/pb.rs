...
pub fn to_addr_meta(
    ...
    let identity = pb.tls_identity.and_then(to_identity);
...
// TODO: differenciate between ServerId and ServerName
fn to_identity(pb: TlsIdentity) -> Option<(ServerId, ServerName)> {
