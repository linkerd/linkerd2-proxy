...
use crate::http::router::{RequestCountFamilies, ResponseMetricFamilies};
...
pub struct InboundMetrics {
    ...
    pub responses: ResponseMetricFamilies,
}
...
impl InboundMetrics {
    pub(crate) fn new(proxy: Proxy, reg: &mut prom::Registry) -> Self {
        ...
        let responses = ResponseMetricFamilies::register(reg);
