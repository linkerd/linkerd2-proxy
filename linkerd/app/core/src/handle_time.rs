...
impl Metrics {
    ...
    pub const HELP: &'static str =
        "A histogram of the time in microseconds between when a request is \
         received and when it is sent upstream.";
    ...
    pub fn outbound(&self) -> Scope {
        self.outbound.clone()
    }

    pub fn inbound(&self) -> Scope {
        self.inbound.clone()
    }

    fn metric(&self) -> Metric<'_, &str, Scope> {
